<div class="mt-8 bg-neutral pt-9 text-neutral-content" id="contact">
	<div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
		<div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
			<div class="md:w-[316px]">
				<img src="/logo_full_white.png" class=" h-8" alt="" />

				<p class="mt-2 text-[15px] font-normal text-white/[80%]">
					Bringing AI to Every Student, Every Phone
				</p>
				<div class="mt-[18px] flex gap-4">
					...
					><a class="hover:scale-110" target="_blank" href=""
						...
						/></a
					><a class="hover:scale-110" target="_blank" href="https://www.youtube.com/"
						><img
							alt="youtube icon"
							loading="lazy"
							width="36"
			...
			>
				...
				<div class="mt-6 flex flex-col gap-4 sm:mt-0">
					<p class="text-deutziawhite font-inter text-[18px] font-medium">Contact Us</p>
					<div class="mt-2 flex">
						...
						<div class="ml-[18px]">
							<a href="tel:+256787253360" class="font-Inter text-[14px] font-medium text-white"
								>+256 787 253 360
							</a>
					...
					<div class="mt-[23px] flex">
						...
						<div class="ml-[18px]">
							<a
								href="mailto:help@katorchgpt.com"
								class="font-Inter text-[14px] font-medium text-[#fff]">help@katorchgpt.com</a
							>
					...
					<div class="mt-[23px] flex">
						...
						<div class="ml-[18px]">
							<a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]"
								>Busiika, Luweero, Uganda</a
							>
		...
		<!-- <hr class="mt-[30px] text-white/20" /> -->
